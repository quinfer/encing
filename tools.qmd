...
Missing data can skew analyses and lead to inaccurate conclusions. 
Use the `is.na()` function to identify missing data.
...
A common method is to use Z-scores or interquartile range (IQR).
