...
3. **Define the Bellman Equation**: This will be used to update the Q-values. The equation is: 
   \[ Q(state, action) = Q(state, action) + \alpha * (reward + \gamma * \max_{a} Q(next\_state, a) - Q(state, action)) \]
