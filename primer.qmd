...
format: html
---
![](images/logos/DALL·E 2024-01-18 16.32.37 - Create a professional logo for an advanced financial data analytics course. The design should be vibrant, with a medium level of detail, balancing com.png){width="70%" style="float: left; margin-right: 10px;"} 
<span class="hand">
